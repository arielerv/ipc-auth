...
export type HandlerSync = (
    req: Request<null, null, null, RequestQuerySync>,
    res: Response,
    next: NextFunction,
) => Promise<Response>;

export type HandlerSyncUpdate = (
    req: Request<null, null, RequestBodySyncUpdate>,
    res: Response,
    next: NextFunction,
) => Promise<Response>;
...
export type HandlerGetSurveys = (
    req: Request<null, null, RequestBodySyncUpdate, RequestQuerySurveys>,
    res: Response,
    next: NextFunction,
) => Promise<Response>;
...
export type GetReferenceSurveys = (
    token: string,
    queries: RequestQuerySurveys,
) => Promise<SyncGetReferenceSurveysResponse>;
